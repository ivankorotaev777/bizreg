...
<Lead>
LLC charter capital in Uzbekistan is surrounded by myths: some expect a fixed minimum like in other countries, others assume the money must be "frozen" in an account before registration. In practice it works differently. A regular LLC has no universal minimum, while a foreign enterprise does have a threshold. Let's lay it out clearly: how much, in what form, by when, and what currency nuances await a foreign founder.
</Lead>
...
## What charter capital is and why it matters
...
## Minimum size: regular LLC vs foreign enterprise
...
## Deadlines: the key rule is one year
