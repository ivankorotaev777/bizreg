...
faq:
  ...
  - q: "Can a Ukrainian citizen register a sole proprietorship (IP) in Uzbekistan?"
    a: "No. The sole proprietor status (IP) is not available to foreigners — it is only for citizens and residents of Uzbekistan. A Ukrainian citizen should use an LLC or a foreign enterprise (an LLC with 100% foreign capital)."
...
In the Uzbek context the abbreviation IP often means a foreign enterprise (an LLC with 100% foreign capital), not a sole proprietor. Out of habit, Ukrainians look for an analogue of the FOP — it does not exist for a foreigner. Remember this from the start so you don't waste time on an unsuitable form.
</Callout>
...
<ProsCons>
  ...
  - Counting on opening an IP/FOP as a foreigner
...
No. The sole proprietor status is available only to citizens and residents of Uzbekistan. A Ukrainian citizen should use an LLC or a foreign enterprise — an LLC with 100% foreign capital. There is no direct analogue of the Ukrainian FOP for a foreigner.
</Faq>
