...
faq:
  - q: "Can a foreigner open an IT company in Uzbekistan?"
    a: "Yes. A foreigner registers a legal entity — an LLC or a foreign enterprise (an LLC with 100% foreign capital). Sole proprietorship is not available to foreigners. After registration, the company applies for IT Park resident status."
...
## Why Uzbekistan for an IT business
...
## The route map: from idea to launch
...
It is a company, not a person, that becomes an IT Park resident, so the form has to be right from the outset. Here is the critical nuance for foreigners: **sole proprietorship is not available to foreigners** — it is open only to citizens and residents of Uzbekistan. A foreign founder uses an **LLC** or a **foreign enterprise** (the same LLC, but with 100% foreign capital). We cover registration in detail in a separate article — [how to open an LLC in Uzbekistan step by step](/blog/kak-otkryt-ooo-poshagovo).

<Callout type="warning" title="A foreigner needs an entity, not a sole proprietorship">
If you were searching for how to register as a sole proprietor for IT — that form is closed to foreigners. For IT Park resident status you will use an **LLC** or a **foreign enterprise**. Build this into the structure at the planning stage so you do not have to redo documents later.
</Callout>
...
Yes. A foreigner registers a legal entity — an LLC or a foreign enterprise (an LLC with 100% foreign capital). Sole proprietorship is not available to foreigners. After registration, the company applies for IT Park residency.
</Faq>
