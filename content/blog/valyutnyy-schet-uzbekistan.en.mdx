...
cluster: "C9"
keyword: "foreign currency account in Uzbekistan"
author: "ivan"
accent: "amber"
heroStyle: "photo"
...
faq:
  ...
  - q: "Can a foreign enterprise open a currency account?"
    a: "Yes. A foreign enterprise and an LLC with foreign participation open a currency account on the same basis as local companies. A sole proprietorship (IP) is available to a foreigner only with residency in Uzbekistan, so a non-resident usually opens an LLC — the account is always opened by a legal entity. The bank runs enhanced compliance on the source of funds."
...
<Callout type="warning" title="IP — only with residency in Uzbekistan">
If you were considering «opening an IP for a currency account» — for a non-resident this is usually a dead end: a [sole proprietor in Uzbekistan for foreigners](/en/blog/ip-v-uzbekistane-dlya-inostrancev) is available only with residency in the country and with limits, so an LLC is simpler. The currency account is opened by a legal entity: an LLC or a foreign enterprise. Accurate as of 2026-06-15.
</Callout>
