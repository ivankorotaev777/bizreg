...
faq:
  ...
  - q: "Can a foreign SaaS founder become an IT Park resident?"
    a: "Yes, but only through a legal entity — an LLC or a foreign enterprise. A foreigner cannot register individual entrepreneurship in Uzbekistan, so the company is registered first and then obtains resident status."
sources:
...
For a foreign founder the order of steps differs from a local entrepreneur in one fundamental point: the resident is the company, not the person, and individual entrepreneurship is unavailable to foreigners. So the path always starts with registering a legal entity.
...
- A foreign founder gets the status only through a legal entity (LLC or foreign enterprise), not through individual entrepreneurship.
...
Yes, but only through a legal entity — an LLC or a foreign enterprise. Individual entrepreneurship is unavailable to foreigners, so the company is registered first and then the residency application is filed.
</Faq>
