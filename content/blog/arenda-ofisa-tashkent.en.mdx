...
<CompareGrid>
  ...
  You take a legal address for registration (with a guarantee letter) and, if needed, a coworking seat for work. This format — sometimes called a virtual office address Tashkent — is cheaper, more flexible and faster to start; it suits most new companies and is a common entry point for foreign founders.
  </CompareCard>
</CompareGrid>
...
Registration requires a legal address (registered location), but that is not always a full rented office. An office, premises offered as an address with the owner's guarantee letter, or a coworking space — sometimes referred to as a virtual office address Tashkent — can all work. Verify the exact requirements on lex.uz and my.gov.uz.
</Faq>
