...
<Lead>
Turnover tax (often called the simplified turnover regime) is the easiest way to pay taxes in Uzbekistan: a percentage of revenue, with no credits, no input VAT and no electronic invoices. Almost every small business and foreign founder starts here. In 2026 the regime became even more attractive: the threshold at which you must move to VAT rose nearly five-fold. Let's break down who turnover tax suits, what rates apply by activity, and when the switch to VAT kicks in.
</Lead>
...
## What turnover tax is, in plain terms
...
## Turnover tax rates by activity in 2026
...
## The VAT threshold: the key change of 2026
