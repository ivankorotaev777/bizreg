...
<Lead>
"What is better — the simplified tax or VAT?" is the first question almost every entrepreneur in Uzbekistan asks. And the answer is almost always "it depends." In 2026 the choice became both harder and more interesting: from June 1 a new simplified VAT at 6% appeared, and the threshold for mandatory VAT rose to nearly 5 billion sum. Business now effectively has three tax regimes, and getting the choice right can mean hundreds of millions of sum. Let's break down each one, compare them in a table, and calculate the tax burden on concrete numbers.
</Lead>
...
## The three 2026 regimes: the essentials
...
## Regime 2: 6% simplified VAT (new in 2026)
...
## How to choose a regime: a step-by-step algorithm
