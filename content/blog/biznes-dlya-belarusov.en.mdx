...
description: "How a Belarus citizen opens a business in Uzbekistan in 2026: visa-free entry, the Belarus–Uzbekistan double tax treaty, IT relocation, forms, account and taxes."
...
faq:
  ...
  - q: "Can a Belarus citizen register a sole proprietorship (IP) in Uzbekistan?"
    a: "No. A foreigner does not register a sole proprietor in Uzbekistan. A Belarus citizen can use an LLC or a foreign enterprise — an LLC with 100% foreign capital. The IP model familiar from Belarus is not available here."
...
This is the key difference from the familiar Belarusian model, and almost everyone stumbles on it. In Belarus many people start with an IP (sole proprietorship). **In Uzbekistan a foreigner cannot register a sole proprietor.** The familiar "I'll just open an IP" route is not available to a Belarus citizen.
...
In the Uzbek context the abbreviation IP often means "foreign enterprise" (an LLC with 100% foreign capital), not "sole proprietor" as in Belarus. Because the letters coincide, Belarusians regularly get confused. Remember: there is no sole proprietor status for a foreigner in Uzbekistan.
</Callout>
...
<ProsCons>
  ...
  - Counting on opening an IP as a foreigner
...
- A foreigner registers only an LLC or a foreign enterprise (IP LLC) — an IP is not available.
...
No. A foreigner does not register a sole proprietor. An LLC or a foreign enterprise is available — an LLC with 100% foreign capital. The IP model familiar from Belarus is not available here.
</Faq>
