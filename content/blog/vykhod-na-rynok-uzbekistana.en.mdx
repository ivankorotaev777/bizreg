...
faq:
  ...
  - q: "Can an outsourcing company get IT Park incentives?"
    a: "Yes. BPO, call centres, design and IT support qualify for IT Park residency when services are provided to non-residents of Uzbekistan using software. The same incentives apply: 0% profit tax/VAT/social tax until 2028, 7.5% personal income tax, 1% turnover contribution."
sources:
  ...
  - title: "Government services portal — gov.uz"
    url: "https://gov.uz"
  - title: "IT Park eligible activities — it-park.uz"
    url: "https://it-park.uz/en/itpark/residents/requirements"
  - title: "Special Economic Zones in Uzbekistan — invest.miit.uz"
...
- full exemption from profit tax, VAT and social tax until 2028;
- personal income tax for employees of just 7.5%;
- the ability to open accounts in multiple currencies, including rouble accounts — payments to developers in Russia or Belarus are not a problem;
- the ability to connect Stripe and other international payment systems;
- access to the IT Park ecosystem: accelerators, grants, networking.
...
<InlineCta href="/">Want to know if your product qualifies for IT Park? We will assess your situation for free.</InlineCta>
...
- register an LLC with a foreign participant (or a foreign enterprise);
- operate on the general regime: 15% profit tax, VAT (0% rate on exports);
- open multi-currency accounts for working with international counterparties;
- set up logistics and customs clearance under Uzbek rules.
...
- exemption from profit tax for up to 10 years (depending on investment volume: $3–5 million — 3 years; $5–15 million — 5 years; above $15 million — 10 years);
- exemption from property tax, land tax and water-use tax;
- preferential customs treatment on the import of equipment and raw materials for export production.
...
For companies providing services or consulting in Uzbekistan, the most common and convenient regime is the **simplified tax system with a 4% turnover tax**. This is a lightweight structure without VAT or profit tax, as long as annual turnover stays below 12,000 BRV (≈5 billion sums). Many firms — from IT contractors to Uzbekistan business consultants — start on this regime and switch only when turnover grows beyond the threshold.
...
- **export call centres** (serving clients of foreign companies);
- **outsourced accounting and financial services** for non-residents;
- **BPO (Business Process Outsourcing)** — management of business processes for foreign companies;
- **IT support and helpdesk** for foreign clients;
- **design, web and multimedia** services for export.
...
<Faq q="Can an outsourcing company (call centre, BPO) get IT Park incentives?">
...
<Faq q="Can an export company apply the simplified tax system (4%)?">
...
<Faq q="What incentives does the Nukus SEZ offer manufacturing companies?">
...
<Faq q="Is e-commerce a good market entry option in Uzbekistan?">
