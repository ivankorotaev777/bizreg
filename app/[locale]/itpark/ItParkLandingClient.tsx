...
const itparkContent = {
  ru: {
    ...
    offerCards: [
      ...
      { title: "Специальные условия на решения по юридическому адресу", desc: "Юридический адрес и офисные решения для вашего бизнеса без НДС.", oldPrice: "1 456 000 сум", newPrice: "from 1 164 900 сум" },
  ...
  en: {
    ...
    offerCards: [
      ...
      { title: "Special terms for legal address solutions", desc: "Registered address and office solutions for your business without VAT.", oldPrice: "1 456 000 UZS", newPrice: "from 1 164 900 UZS" },
  ...
  kk: {
    ...
    offerCards: [
      ...
      { title: "Заңды мекенжай шешімдеріне арнайы шарттар", desc: "Бизнесіңіз үшін ҚҚС-сыз заңды мекенжай және офис шешімдері.", oldPrice: "1 456 000 сум", newPrice: "from 1 164 900 сум" },
  ...
  uz: {
    ...
    offerCards: [
      ...
      { title: "Yuridik manzil yechimlari uchun maxsus shartlar", desc: "Biznesingiz uchun QQSsiz yuridik manzil va ofis yechimlari.", oldPrice: "1 456 000 so'm", newPrice: "from 1 164 900 so'm" },
  ...
  zh: {
    ...
    offerCards: [
      ...
      { title: "法定地址解决方案特别条件", desc: "为您的业务提供不含增值税的法定地址与办公方案。", oldPrice: "1 456 000 苏姆", newPrice: "from 1 164 900 苏姆" },
