...
const faq = [
  ["Можете ли вы помочь с запуском компании в Узбекистане?", "Да. Мы оказываем частную консалтинговую поддержку по плану запуска, документам и setup-этапам в Узбекистане."],
  ...
  ["Могут ли иностранные предприниматели начать бизнес в Узбекистане?", "Да. Мы сопровождаем иностранных учредителей по локальному setup, документам и операционным этапам запуска."],
  ...
  ["Помогаете ли вы с бухгалтерским онбордингом и шагами комплаенса?", "Да. Мы помогаем настроить бухгалтерские процессы, подготовку отчетности и практические шаги комплаенса."],
  ["Как быстро можно начать операционную деятельность при правильном setup-плане?", "Срок зависит от вашего кейса и готовности документов; мы даем практическую дорожную карту и реалистичный таймлайн."],
...
const itparkText = {
  ru: {
    ...
    heroTitle: "Консультационные услуги по запуску бизнеса для компаний, ориентированных на IT Park Узбекистана.",
    heroDesc: "Получите скидку {discount} на консалтинговые услуги по регистрации компании и специальные условия на юридический адрес, если открываетесь через BizReg для подачи в IT Park.",
    ...
    faqTitle: "FAQ",
    contactTitle: "Планируете запуск бизнеса под IT Park?",
    contactDesc: "Оставьте заявку — мы оценим, соответствует ли ваш бизнес требованиям IT Park, и предложим условия частного консалтинга по запуску и юридическому адресу.",
    getOffer: "Записаться на консультацию",
  },
  en: {
    badge: "Special Offer from BizReg",
    heroTitle: "Business setup consulting for IT Park-focused companies",
    heroDesc: "Get a {discount} discount on business launch support and special terms for legal address solutions when working with BizReg for IT Park application.",
    ...
    faqTitle: "FAQ",
    contactTitle: "Planning to launch a business for IT Park?",
    contactDesc: "Leave a request — we will assess whether your business fits IT Park requirements and offer favorable private consulting terms for setup and registered address solutions.",
    getOffer: "Schedule Consultation",
  },
  kk: {
    badge: "BizReg арнайы ұсынысы",
    heroTitle: "IT Park-қа бағытталған компаниялар үшін бизнесті іске қосу консалтингі",
    heroDesc: "BizReg-пен IT Park өтінімі бойынша жұмыс істесеңіз, бизнесті іске қосу қолдауына {discount} жеңілдік және заңды мекенжай шешімдеріне арнайы шарттар алыңыз.",
    heroCta: "Кеңес сұрау",
    ...
    faqTitle: "FAQ",
    contactTitle: "IT Park үшін бизнесті іске қосуды жоспарлап отырсыз ба?",
    contactDesc: "Өтінім қалдырыңыз — бизнесіңіздің IT Park талаптарына сәйкестігін бағалап, іске қосу және заңды мекенжай шешімдері бойынша жеке консалтинг шарттарын ұсынамыз.",
    getOffer: "Кеңеске жазылу",
  },
  uz: {
    badge: "BizReg maxsus taklifi",
    heroTitle: "IT Park-ga yo'naltirilgan kompaniyalar uchun biznesni ishga tushirish konsaltingi",
    heroDesc: "BizReg bilan IT Park arizasi bo'yicha ishlasangiz, biznesni ishga tushirish qo'lloviga {discount} chegirma va yuridik manzil yechimlariga maxsus shartlarni oling.",
    heroCta: "Konsultatsiya so'rash",
    ...
    faqTitle: "FAQ",
    contactTitle: "IT Park uchun biznesni ishga tushirishni rejalashtiryapsizmi?",
    contactDesc: "Ariza qoldiring — biznesingiz IT Park talablariga mosligini baholab, ishga tushirish va yuridik manzil yechimlari bo'yicha xususiy konsalting shartlarini taklif qilamiz.",
    getOffer: "Konsultatsiyaga yozilish",
  },
  zh: {
    badge: "BizReg 特别优惠",
    heroTitle: "面向 IT Park 方向企业的业务启动咨询",
    heroDesc: "通过 BizReg 申请 IT Park，可获得业务启动支持 {discount} 折扣及法定地址解决方案特别条件。",
    heroCta: "申请咨询",
    ...
    reviewsTitle: "案例与评价",
    faqTitle: "FAQ",
    contactTitle: "计划面向 IT Park 启动业务吗？",
    contactDesc: "提交申请——我们将评估您的业务是否符合 IT Park 要求，并提供业务启动与法定地址解决方案的私人咨询条件。",
    getOffer: "预约咨询",
  },
} as const;
...
const itparkContent = {
  ru: {
    heroFeatures: ["Полное сопровождение запуска бизнеса", "Специальные условия для IT Park", "Решения по юридическому адресу", "Поддержка на русском / английском / узбекском"],
    featuredActivities,
    ...
    offerCards: [
      { title: "Скидка 20% на услуги по запуску бизнеса", desc: "Полное сопровождение запуска бизнеса.", oldPrice: "5 000 000 сум", newPrice: "3 990 000 сум" },
      { title: "Специальные условия на решения по юридическому адресу", desc: "Юридический адрес и офисные решения для вашего бизнеса без НДС.", oldPrice: "1 272 000 сум", newPrice: "1 017 600 сум" },
      { title: "Бухгалтерский учет (пакет Start-up)", desc: "Стартовый пакет учета включает сдачу всех отчетов и базовые операции.", newPrice: "780 000 сум" },
      { title: "Помощь в заполнении бизнес-плана", desc: "Наш 5 летний опыт поможет вам правильно заполнить бизнес план.", newPrice: "1 200 000 сум" },
    ],
    offerNote: "Предложение действует для клиентов, которые запускают бизнес через частный консалтинг BizReg для подачи в IT Park.",
    services: [
      "Консультация по запуску бизнеса и подаче в IT Park",
      "Подготовка регистрационного пакета",
      "Сопровождение по документам и административному онбордингу",
      "Решения по юридическому адресу и офису",
      "Сопровождение по открытию счета",
      "Консультация по подготовке к подаче в IT Park",
    ],
    reviews: [
      ["Founder, IT-сервис", "«Запустили бизнес удаленно и быстро вышли на следующий этап подачи в IT Park.»"],
  ...
  en: {
    heroFeatures: ["End-to-end business launch support", "Special terms for IT Park", "Registered address solutions", "Support in Russian / English / Uzbek"],
    featuredActivities: [
    ...
    offerCards: [
      { title: "20% discount on business setup support", desc: "End-to-end business launch support.", oldPrice: "5 000 000 UZS", newPrice: "3 990 000 UZS" },
      { title: "Special terms for legal address solutions", desc: "Registered address and office solutions for your business without VAT.", oldPrice: "1,272,000 UZS", newPrice: "1,017,600 UZS" },
      { title: "Accounting (Start-up package)", desc: "Starter package includes all reporting and basic operations.", newPrice: "780 000 UZS" },
      { title: "Business plan preparation support", desc: "Our 5 years of experience helps you prepare a correct business plan.", newPrice: "1 200 000 UZS" },
    ],
    offerNote: "Offer applies to clients launching a business through BizReg private consulting for IT Park application.",
    services: [
      "Consultation on business setup and IT Park application process",
      "Registration package preparation",
      "Documentation and administrative onboarding guidance",
      "Registered address and office solutions",
      "Bank account opening support",
      "Consultation for IT Park application preparation",
    ],
    reviews: [
      ["Founder, IT service", "\"We launched our business remotely and quickly moved to the next IT Park application stage.\""],
    ...
    faq: [
      ["Can you help me launch a company in Uzbekistan?", "Yes. We provide private consulting support for launch planning, documentation, and setup steps in Uzbekistan."],
      ...
      ["Can foreign entrepreneurs start a business in Uzbekistan?", "Yes. We support foreign founders with local setup guidance, documentation planning, and operational onboarding."],
      ["Do you help with legal address?", "Yes, we provide special legal address terms within this offer."],
      ["Do you assist with accounting onboarding and compliance steps?", "Yes. We help set up accounting workflows, reporting readiness, and practical compliance steps for ongoing operations."],
      ["How quickly can I begin operations with the right setup plan?", "Timing depends on your case and document readiness; we provide a practical roadmap and realistic timeline."],
  ...
  kk: {
    heroFeatures: ["Бизнесті іске қосуды толық қолдау", "IT Park үшін арнайы шарттар", "Заңды мекенжай шешімдері", "Қазақ / ағылшын / өзбек тілдерінде қолдау"],
    featuredActivities: [
    ...
    offerCards: [
      { title: "Бизнес іске қосу қолдауына 20% жеңілдік", desc: "Бизнесті іске қосуды толық қолдау.", oldPrice: "5 000 000 сум", newPrice: "3 990 000 сум" },
      { title: "Заңды мекенжай шешімдеріне арнайы шарттар", desc: "Бизнесіңіз үшін ҚҚС-сыз заңды мекенжай және офис шешімдері.", oldPrice: "1 272 000 сум", newPrice: "1 017 600 сум" },
      { title: "Бухгалтерия (Start-up пакеті)", desc: "Бастапқы пакет барлық есептерді тапсыру мен базалық операцияларды қамтиды.", newPrice: "780 000 сум" },
      { title: "Бизнес-жоспар толтыруға көмек", desc: "5 жылдық тәжірибеміз бизнес-жоспарды дұрыс толтыруға көмектеседі.", newPrice: "1 200 000 сум" },
    ],
    offerNote: "Ұсыныс IT Park-қа өтінім беру үшін BizReg-пен жеке консалтинг форматында жұмыс істейтін клиенттерге арналған.",
    services: ["Компанияны іске қосу және IT Park өтінімі бойынша кеңес", "Құжаттар пакетін дайындау", "Әкімшілік онбординг бойынша бағыт-бағдар", "Заңды мекенжай және офис шешімдері", "Шот ашуға сүйемелдеу", "IT Park-қа өтінім дайындау бойынша кеңес"],
    ...
    faq: [
      ["Өзбекстанда компанияны іске қосуға көмектесе аласыздар ма?", "Иә. Біз іске қосу жоспары, құжаттар және орнату қадамдары бойынша жеке консалтинг қолдауын көрсетеміз."],
      ...
      ["Шетелдік кәсіпкерлер Өзбекстанда бизнес бастай ала ма?", "Иә. Біз шетелдік құрылтайшыларға жергілікті орнату, құжаттар және операциялық қадамдар бойынша қолдау көрсетеміз."],
      ["Заңды мекенжай бойынша көмектесесіздер ме?", "Иә, осы ұсыныс аясында заңды мекенжайға арнайы шарттар бар."],
      ["Бухгалтериялық онбординг пен комплаенс қадамдарына көмектесесіздер ме?", "Иә. Біз есепке қою, есептілікке дайындық және практикалық комплаенс қадамдарын реттеуге көмектесеміз."],
      ["Дұрыс setup-жоспарымен операцияны қаншалықты жылдам бастауға болады?", "Мерзім кейс ерекшелігіне және құжаттардың дайындығына байланысты. Біз практикалық жол картасы мен нақты таймлайн береміз."],
  ...
  uz: {
    heroFeatures: ["Biznesni ishga tushirishni to'liq qo'llab-quvvatlash", "IT Park uchun maxsus shartlar", "Yuridik manzil yechimlari", "Ingliz / o'zbek / rus tillarida qo'llab-quvvatlash"],
    featuredActivities: [
    ...
    offerCards: [
      { title: "Biznesni ishga tushirish qo'lloviga 20% chegirma", desc: "Biznesni ishga tushirishni to'liq qo'llab-quvvatlash.", oldPrice: "5 000 000 so'm", newPrice: "3 990 000 so'm" },
      { title: "Yuridik manzil yechimlari uchun maxsus shartlar", desc: "Biznesingiz uchun QQSsiz yuridik manzil va ofis yechimlari.", oldPrice: "1 272 000 so'm", newPrice: "1 017 600 so'm" },
      { title: "Buxgalteriya (Start-up paketi)", desc: "Boshlang'ich paket barcha hisobotlar va bazaviy operatsiyalarni o'z ichiga oladi.", newPrice: "780 000 so'm" },
      { title: "Biznes-reja to'ldirish bo'yicha yordam", desc: "5 yillik tajribamiz biznes-rejani to'g'ri to'ldirishga yordam beradi.", newPrice: "1 200 000 so'm" },
    ],
    offerNote: "Taklif IT Parkga ariza topshirish uchun BizReg bilan xususiy konsalting formatida ishlaydigan mijozlar uchun amal qiladi.",
    services: ["Kompaniyani ishga tushirish va IT Park arizasi bo'yicha konsultatsiya", "Hujjatlar paketini tayyorlash", "Ma'muriy onboarding bo'yicha yo'l-yo'riq", "Yuridik manzil va ofis yechimlari", "Hisob raqami ochishga hamrohlik", "IT Parkga topshirishga tayyorgarlik konsultatsiyasi"],
    ...
    faq: [
      ["O'zbekistonda kompaniyani ishga tushirishga yordam bera olasizmi?", "Ha. Biz ishga tushirish rejasini tuzish, hujjatlar va setup bosqichlari bo'yicha xususiy konsalting yordamini ko'rsatamiz."],
      ...
      ["Xorijiy tadbirkorlar O'zbekistonda biznes boshlay oladimi?", "Ha. Biz xorijiy ta'sischilar uchun mahalliy setup, hujjatlar va operatsion bosqichlar bo'yicha yordam beramiz."],
      ["Yuridik manzil bo'yicha yordam berasizmi?", "Ha, ushbu taklif doirasida yuridik manzil uchun maxsus shartlar mavjud."],
      ["Buxgalteriya onboarding va compliance bosqichlarida yordam berasizmi?", "Ha. Biz hisobga qo'yish, hisobotga tayyorgarlik va amaliy compliance bosqichlarini yo'lga qo'yishda yordam beramiz."],
      ["To'g'ri setup reja bilan operatsiyani qanchalik tez boshlash mumkin?", "Muddat case tafsilotlari va hujjatlar tayyorligiga bog'liq. Biz amaliy yo'l xaritasi va real timeline beramiz."],
  ...
  zh: {
    heroFeatures: ["业务启动全流程支持", "IT Park 特别条件", "法定地址解决方案", "中文 / 英语 / 俄语支持"],
    featuredActivities: [
    ...
    offerCards: [
      { title: "业务启动支持 20% 折扣", desc: "业务启动全流程支持。", oldPrice: "5 000 000 苏姆", newPrice: "3 990 000 苏姆" },
      { title: "法定地址解决方案特别条件", desc: "为您的业务提供不含增值税的法定地址与办公方案。", oldPrice: "1 272 000 苏姆", newPrice: "1 017 600 苏姆" },
      { title: "会计服务（Start-up 套餐）", desc: "基础会计套餐包含全部报表提交和基础业务处理。", newPrice: "780 000 苏姆" },
      { title: "商业计划书填写支持", desc: "我们 5 年经验可帮助您正确完成商业计划书。", newPrice: "1 200 000 苏姆" },
    ],
    offerNote: "本优惠适用于通过 BizReg 私人咨询模式申请 IT Park 的客户。",
    services: ["业务启动与 IT Park 申请咨询", "材料包准备", "行政 onboarding 指导", "法定地址与办公解决方案", "银行账户开立支持", "IT Park 申请准备咨询"],
    ...
    faq: [
      ["你们可以帮助我在乌兹别克斯坦启动公司吗？", "可以。我们提供启动规划、材料准备和 setup 步骤的私人咨询支持。"],
      ["我的业务是否符合 IT Park 要求？", "我们会进行预审，并建议如何正确定位和描述您的业务活动。"],
      ["如果我是外籍创始人怎么办？", "我们为外籍创始人提供完整流程支持，包括材料清单与远程办理方案。"],
      ["外国创业者可以在乌兹别克斯坦开始业务吗？", "可以。我们可为外国创始人提供本地 setup、材料规划与运营落地支持。"],
      ["你们能协助法定地址吗？", "可以。本优惠包含法定地址的特别条件。"],
      ["你们是否协助会计 onboarding 和合规步骤？", "可以。我们协助建立会计流程、申报准备与实务合规步骤。"],
      ["在正确的 setup 方案下，我多久可以开始运营？", "时间取决于个案情况和材料准备进度；我们会提供务实的路线图与时间表。"],
