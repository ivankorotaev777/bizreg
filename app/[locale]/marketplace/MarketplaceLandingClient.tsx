...
const KK: Content = {
  eyebrow: "Wildberries · Өзбекстан · шетелдіктерге",
  h1a: "Өзбекстанда ",
  h1accent: "Wildberries",
  h1b: "-те сатушы болу — кілтпен тапсыру",
  sub: "Шетелдік WB-те жеке тұлға ретінде сауда жасай алмайды — Өзбекстанда бизнес пен шот керек. ЖШС ашамыз және маркетплейске құжаттарды дайындаймыз. Жеке келмей-ақ.",
  cta: "WB үшін бизнес ашу",
  ctaMore: "Бұл қалай жұмыс істейді",
  note: "Ресей, Қазақстан, Түркия және басқа елдердің резидент еместерімен жұмыс істейміз.",
  stats: [
    { v: "$605 млн", l: "2024 жылы Өзбекстаннан Wildberries-тегі сауда — 2025 жылы екі еседен астам өсті" },
    { v: "100 000 м²", l: "2026 жыл соңына Ташкент маңындағы WB қоймасы" },
    { v: "7 500", l: "логистика орталығындағы жұмыс орны" },
  ],
  barriersTitle: "Резидент емес неге жай ғана кіріп сата алмайды",
  barriers: [
    { ic: "🏢", t: "Жергілікті бизнес керек", d: "Сатушы кабинеті тек Өзбекстанда тіркелген ЖК немесе заңды тұлғаға ашылады." },
    { ic: "🏦", t: "Өзбек банкінде шот керек", d: "Wildberries түсімді бизнестің өзбек банкіндегі шотына аударады." },
    { ic: "📄", t: "Құжаттар мен мәртебе", d: "Куәлік, СТН, soliq.uz-те WB-ті комиссионер ретінде қосу. Қадамды өткізіп алсаңыз — есеп дұрыс болмайды." },
  ],
  stepsTitle: "Wildberries-ке шығу — 6 қадам",
  steps: [
    { t: "ЖШС ашамыз", d: "ЖШС ұсынылады: тіркелу мен ЫҚ талап етпейді, тек заңды тұлға шетелден тауар импорттай алады (Ресей, Қытай т.б.)." },
    { t: "Есеп-шот ашамыз", d: "Өзбек банкінде — Wildberries түсімді осында аударады." },
    { t: "WB Partners-те тіркелеміз", d: "wildberries.uz → «Бизнес үшін» → «Сатушы болу»." },
    { t: "Құжаттарды жүктейміз", d: "Паспорт, тіркеу куәлігі және банк деректемелері." },
    { t: "WB-ті комиссионер ретінде қосамыз", d: "my.soliq.uz-те — дұрыс есеп үшін міндетті қадам." },
    { t: "Схема таңдап, сатамыз", d: "Негізгі схема — FBW: тауар WB қоймасында, жеткізуді маркетплейс атқарады." },
  ],
  taxTitle: "Әрі қарай не күтеді: салықтар",
  taxSub: "Аймақтағы ең жеңіл режимдердің бірі. Айналым шектен төмен болса — күрделі ҚҚС емес, қарапайым айналым салығы.",
  taxHead: ["Салық", "2026 мөлшерлеме", "Қашан"],
  taxRows: [
    ["Айналым салығы", "4%-дан", "айналым ҚҚС шегінен төмен (≈5 млрд сум)"],
    ["ҚҚС (сауда)", "6%", "ерікті, 12% орнына"],
    ["ҚҚС (экспорт)", "0%", "экспорт расталса"],
    ["Пайда салығы", "15%", "жеңілдік: жаңаларға бірінші кезеңде 0%"],
    ["Дивидендтер", "10%", "резидент еместерге төлемдер"],
  ],
  taxNote: "2026 жыл мөлшерлемелері. Бірінші кезеңде пайда салығынан босату — алғаш көшкендерге (Өзбекстан СК). soliq.uz-те тексеріңіз.",
  priceTitle: "Кілтпен тапсыру құны",
  priceSub: "Бірінші жол барлығына міндетті, қалғаны — директор резидент емес болып, оған жұмысқа рұқсат пен виза керек болса.",
  priceRows: [
    { name: "Бизнесті тіркеу (ЖШС)", a: "5 000 000 сум", b: "≈ $400" },
    { name: "Директорға жұмысқа рұқсат", a: "4 200 000 сум", b: "≈ $336" },
    { name: "Директорға виза", a: "4 000 000 сум", b: "≈ $320" },
    { name: "Мемлекеттік баж", a: "12 772 000 сум", b: "≈ $1 022" },
  ],
  totalLabel: "Барлығы — 2 күнде шығу",
  totalSum: "25 972 000 сум",
  totalUsd: "≈ $2 078 · 2 күн",
  timelineTitle: "2 күнде шығу — қадам бойынша",
  timelineSub: "Сіз тауармен айналысасыз, біз екі жұмыс күнінде бастау үшін бәрін дайындаймыз.",
  day1t: "1-күн — компания ашамыз",
  day1d: "ЖШС тіркейміз, СТН мен заңды мекенжай аламыз, құжаттар пакетін дайындаймыз.",
  day2t: "2-күн — шот, виза, құжаттар",
  day2d: "Шот ашамыз, директорға рұқсат пен виза ресімдейміз және WB Partners үшін пакетті береміз.",
  otherTitle: "Тек Wildberries емес",
  otherText: "Ашылған компания барлық маркетплейстерге бірден жарайды. Uzum Market пен Ozon-ға да шығуға көмектесеміз — сол ЖШС-те, әрқайсысына жаңа бизнес ашпай.",
  needTitle: "Сізден тек үш нәрсе керек",
  needSub: "Сапар мен кезек жоқ. Деректерді жібересіз — қалғанын біз қашықтан жасаймыз.",
  need: [
    { ic: "🪪", t: "Паспорт", d: "Құрылтайшының (және басқа болса, директордың) паспорт көшірмесі." },
    { ic: "🏷️", t: "Атауы мен қызмет түрі", d: "Компания атауы мен қызметі — қажет болса кеңес береміз." },
    { ic: "🛍️", t: "Не сатпақсыз", d: "Тауар санаты — таңбалау мен алаң ерекшеліктерін ескеру үшін." },
  ],
  faqTitle: "Жиі қойылатын сұрақтар",
  faq: [
    { q: "Жергілікті компаниясыз сатуға бола ма?", a: "Жоқ. Сатушы кабинеті тек Өзбекстанда тіркелген бизнеске ашылады." },
    { q: "Неге ЖШС, ЖК емес?", a: "ЖШС тіркелу талап етпейді, тек заңды тұлға тауар импорттай алады — сатушылардың тауары әрдайым дерлік импорттан." },
    { q: "Жеке келу керек пе?", a: "ЖШС үшін — жоқ, өкіл арқылы қашықтан тіркейміз." },
    { q: "Директорға виза мен рұқсат керек пе?", a: "Иә, директор резидент емес болса. Мұны да өз мойнымызға аламыз." },
    { q: "Бір компанияда Uzum мен Ozon-ға шығуға бола ма?", a: "Иә, бір компания барлық маркетплейстерге жарайды." },
  ],
  finalTitle: "Wildberries үшін бизнес пен шот ашамыз",
  finalSub: "Байланыс деректеріңізді қалдырыңыз — бизнес түрін таңдап, мерзім мен құнды есептейміз.",
};

const DICT: Record<string, Content> = { ru: RU, en: EN, uz: UZ, zh: ZH, kk: KK };
