...
const content = {
  ru: {
    ...
    faq: [
      ...
      ["Что нужно от меня для старта? Нужен ли уставный капитал и сколько?", "От вас — паспорта учредителей, название, виды деятельности и контакты. Для обычного ООО минимальный уставный капитал не установлен — вы определяете его сами. Для предприятия с иностранными инвестициями — от 400 млн сум. Весь пакет документов готовим мы."],
      ["Какие налоги платит ООО и какой режим выбрать?", "Два основных режима: налог с оборота (упрощёнка) — базовая ставка около 4% (зависит от вида деятельности), доступен при обороте до 12 000 БРВ (около 5 млрд сум) в год; при превышении — общая система: НДС 12% и налог на прибыль 15%. Оптимальный режим подберём под вашу деятельность."],
      ...
      ["Сколько занимает регистрация?", "Обычно несколько рабочих дней после подготовки документов. Точный срок зависит от формы, готовности документов и банка — дадим реалистичный таймлайн под ваш случай."],
    ],
  ...
  en: {
    ...
    faqTitle: "FAQ",
    faq: [
      ["Which legal form suits a foreigner for registering a company?", "Foreign nationals have two options, both LLCs: an «LLC with foreign participation» (a joint venture — both local and foreign founders) and a «foreign enterprise» (an LLC with 100% foreign capital). The only difference is the composition of founders. A founder can be either an individual or a foreign company. A foreigner can become a sole proprietor (ИП) only with residence registration in Uzbekistan — i.e. if they live in the country and hold local documents (residence permit/registration). For a non-resident who does not live in Uzbekistan, an LLC is the way to go."],
      ...
      ["What do you need from me? Is charter capital required and how much?", "From you — founders' passports, the company name, activities and contacts. For an ordinary LLC there is no minimum charter capital — you set it yourself. For an enterprise with foreign investment — from 400 million UZS. We prepare the full document package."],
      ["What taxes does an LLC pay and which regime to choose?", "Two main regimes: turnover tax (simplified) — base rate about 4% (depends on the activity), available for turnover up to 12,000 BRV (about 5 billion UZS) per year; above that — the general system: VAT 12% and profit tax 15%. We'll pick the optimal regime for your activity."],
      ...
      ["How long does registration take?", "Usually a few business days after the documents are prepared. The exact term depends on the entity form, document readiness and bank — we'll give a realistic timeline for your case."],
    ],
