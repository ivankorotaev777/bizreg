...
const content = {
  ru: {
    ...
    faq: [
      ...
      ["Поможете с юридическим адресом?", "Да, поможем с не массовым адресом, пригодным для регистрации и постановки на учёт."],
  ...
  en: {
    ...
    faq: [
      ...
      ["Do you help with a legal address?", "Yes, we help with a non-mass address suitable for registration and tax setup."],
